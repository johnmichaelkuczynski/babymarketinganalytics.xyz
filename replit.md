...
**A Friendly, One-Unit Intro to Marketing Analytics That Teaches, Tutors, and Proofs Itself — for Curious Students and Adults Alike**

---

## 🧩 Overview

Marketing Analytics is a self-paced, single-user web course that delivers a friendly, plain-language introduction to marketing analytics — taught, tutored, drilled, and graded entirely by AI, with built-in academic-integrity enforcement. No math, coding, statistics, or other technical skills required.

It turns the everyday business habit of *trying to understand what customers want* into one product: read each lesson at the depth you want, ask a tutor scoped to the exact section you're on, drill questions whose difficulty adapts to you in real time, and submit homework, a unit test, and a final that are AI-graded with feedback and screened for AI-generated answers. The material is kept friendly and age-appropriate — it explains how we use data on what customers actually do to understand them and act, and how to do it honestly, never technical or jargon-heavy.

The curriculum is organized into **one unit and 8 topics** ("Marketing Analytics for Everyone"): 1.1 what marketing analytics is — knowing the customer through data; 1.2 why "the average customer" doesn't exist — segmentation; 1.3 the funnel — tracking the journey from stranger to buyer; 1.4 customer lifetime value — what a customer is really worth; 1.5 churn — spotting who's about to leave before they do; 1.6 A/B testing — letting data settle the argument; 1.7 attribution and personalization — who gets credit, who gets targeted; and 1.8 from insight to campaign.

Designed for **middle schoolers, curious adults wanting brief but meaningful exposure, instructors evaluating AI-taught coursework, and researchers studying AI academic integrity**, Marketing Analytics pairs a real curriculum with two layers of AI-authorship detection — surfacing not just *whether* the writing looks AI-generated, but whether the *act of producing it* did.
...
- **Middle Schoolers & Curious Adults:** A complete, plain-language intro to marketing analytics delivered with on-demand tutoring and adaptive practice — no instructor, math, or coding required.
...
Marketing Analytics reframes an AI-taught course as a *closed accountability loop*.
...
**Marketing Analytics — where the curriculum, the tutor, the grader, and the integrity check all live in one room.**
